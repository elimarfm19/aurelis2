        ...
        <!-- **************************************MENÚ VERTICAL************************************* -->
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="col-md-12" style="background-color: white; background-size: 100% 100%; background-position: center; pointer-events:none;">
                    ...
                    <li class="active">
                        <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> 1</a>
                    </li>
                    <li class="NavLateralDivider"></li>
                    <li>
                        <a href="charts.html"><i class="fa fa-fw fa-bar-chart-o"></i> 2</a>
                    </li>
                    <li class="NavLateralDivider"></li>
                    <li>
